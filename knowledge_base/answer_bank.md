...
Information_security_questionnaire, Merck evaluation, ESTEVE questionnaire (2026-09). When sources disagreed, the
...
*Sources:* ESTEVE questionnaire, 2026-09; Decision C13
...
**Supporting materials:** AWS SOC 1/2/3 and ISO 27001/27017/27018 reports (downloaded from the AWS account); Runtime Monitoring & Logging Infrastructure (Grafana Loki, CloudWatch) (screenshots)
...
For SaaS, all customer data is hosted in the United States, in the AWS North California region (us-west-1), with instances replicated across multiple availability zones. All data, including backups, is stored in the US, in AWS data centres. For local deployment, all data stays in the customer's own infrastructure, so customers who need data localization can choose local deployment.
...
*Sources:* NOVA 3.4; Grü Q47; Servier-email; IFF-VRA 2.8; Decision C13
...
**Supporting materials:** [ChemAIRS SaaS Environment Data Security Management Regulations](https://chemical-ai.feishu.cn/wiki/HBgBwwBPwiutYLkfn7hcbbqbnHz) – §14–16 Data Recovery and Emergency Response
...
All data, including the 7-day local backups and the 3-month off-site disaster recovery backups, is stored in the US, in AWS data centres.

**Supporting materials:** none in the Supporting Materials document

*Sources:* Decision C13; Decisions C9, C10 (retention periods)
...
AWS performs its own emergency recovery and system rebuild exercises periodically; on top of that Chemical.AI tests restores quarterly and runs DR drills twice a year.

**Supporting materials:** [ChemAIRS SaaS Environment Data Security Management Regulations](https://chemical-ai.feishu.cn/wiki/HBgBwwBPwiutYLkfn7hcbbqbnHz) – §18 Regular Assessment

*Sources:* ESTEVE questionnaire, 2026-09; Decision C36; Decision C17
